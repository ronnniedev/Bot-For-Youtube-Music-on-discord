"""
    ...
    -3º Se borra el audio alojado en el sistema, esto hace que el bot sea compatible con uso en la nube ya que no sobrecarga el sistema donde se encuentra con archivos
        ...
        if voice.is_playing():
           await ctx.send("Estoy reproduciendo un audio, espera a que termine o usa el comando -->!stop para que acabe la cancion actual")
            ...
            async with ctx.typing():
                ...
                voice_channel.play(discord.FFmpegPCMAudio(executable="/usr/bin/ffmpeg", source=filename),after=after_playing_callback)
